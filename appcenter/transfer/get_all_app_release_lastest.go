...
func GetAllAppReleaseLasted(config utils.Config, author string, desc string) string {
	...
	return biz.FindAllReleaseApp(androidApp, iosApp).TelegramReleaseMessage(author, desc)
}
